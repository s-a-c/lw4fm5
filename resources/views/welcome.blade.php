    ...
    <style>
      ...
      @layer utilities {
        ...
        .shadow-\[0px_0px_1px_0px_rgba\(0\,0\,0\,0\.03\)\,0px_1px_2px_0px_rgba\(0\,0\,0\,0\.06\)\] {
          --tw-shadow:
            0px 0px 1px 0px var(--tw-shadow-color, #00000008), 0px 1px 2px 0px var(--tw-shadow-color, #0000000f);
          box-shadow:
    ...
    >
      <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        ...
        >
          ...
          {{-- Light Mode 12 SVG --}}
          <svg
            class="w-[448px] max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] dark:hidden"
            viewBox="0 0 440 376"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          {{-- Dark Mode 12 SVG --}}
          <svg
            class="w-[448px] max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] hidden dark:block"
            viewBox="0 0 440 376"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
