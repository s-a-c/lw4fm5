...
- Validate profile prerequisites (Docker Desktop for container, Herd/Homebrew PHP for native)
...
| `use-container.sh` | `composer setup -- --profile=container` | Symlink `.env.container`, ensure Sail/Docker ready |
