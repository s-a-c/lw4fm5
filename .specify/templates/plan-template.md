...
- ✅ Observability plan (structured logs, correlation IDs/OpenTelemetry, RED/USE metrics) defined for new work
- ✅ Performance targets evaluated (API P95 <500ms internal, <1s storefront, queues 1k jobs/min) with mitigation strategy if at risk
